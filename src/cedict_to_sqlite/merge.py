...
if __name__ == '__main__':
    if len(sys.argv) != 4:
        print('Usage: python3 script.py <output database name> <database 1 filename> <database 2 filename>')
    ...
    c.execute('INSERT INTO sources(sourcename) SELECT sourcename FROM db1.sources')
    ...
    c.execute('INSERT INTO sources(sourcename) SELECT sourcename FROM db2.sources')
    ...
    c.execute('''INSERT INTO definitions(definition, fk_entry_id, fk_source_id)
