    ...
    QMainWindow(parent)
{
    ...
    dark_palette.setColor(QPalette::Highlight, Utils::LIST_ITEM_ACTIVE_COLOUR_DARK);
    dark_palette.setColor(QPalette::HighlightedText, Utils::getContrastingColour(Utils::LIST_ITEM_ACTIVE_COLOUR_DARK));
